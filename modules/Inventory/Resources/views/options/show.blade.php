        ...
        <div class="col-md-3">
            ...
            <div class="box box-success">
                ...
                <div class="box-body box-profile">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item" style="border-top: 0;">
                            <b>{{ trans('general.email') }}</b> <a class="pull-right">{{ $option->email }}</a>
                        </li>

                        <li class="list-group-item">
                            <b>{{ trans('general.phone') }}</b> <a class="pull-right">{{ $option->phone }}</a>
                        </li>

                        <li class="list-group-item">
                            <b>{{ trans('general.website') }}</b> <a class="pull-right">{{ $option->website }}</a>
                        </li>

                        <li class="list-group-item">
                            <b>{{ trans('general.tax_number') }}</b> <a class="pull-right">{{ $option->tax_number }}</a>
                        </li>

                        @if ($option->refence)
                        <li class="list-group-item">
                            <b>{{ trans('general.reference') }}</b> <a class="pull-right">{{ $option->refence }}</a>
                        </li>
                        @endif
                    </ul>
                </div>
            ...
            <!-- Edit -->
            <div>
                <a href="{{ url('inventory/options/' . $option->id . '/edit') }}" class="btn btn-primary btn-block"><b>{{ trans('general.edit') }}</b></a>
                <!-- /.box-body -->
            </div>
        </div>
        <!-- /.col -->
                ...
                <div class="col-md-4 col-sm-8 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">@money($amounts['paid'], setting('default.currency'), true)</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-4 col-sm-8 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">@money($amounts['open'], setting('default.currency'), true)</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-4 col-sm-8 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">@money($amounts['overdue'], setting('default.currency'), true)</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-striped table-hover" id="tbl-invoices">
                                        ...
                                        @foreach($invoices as $item)
                                            <tr>
                                                <td><a href="{{ url('inventory/invoices/' . $item->id . ' ') }}">{{ $item->invoice_number }}</a></td>
                                                <td class="text-right amount-space">@money($item->amount, $item->currency_code, true)</td>
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-striped table-hover" id="tbl-revenues">
                                        ...
                                        @foreach($revenues as $item)
                                            <tr>
                                                <td><a href="{{ url('inventory/revenues/' . $item->id . '/edit') }}">{{ Date::parse($item->paid_at)->format($date_format) }}</a></td>
                                                <td class="text-right amount-space">@money($item->amount, $item->currency_code, true)</td>
                                                <td class="hidden-xs">{{ $item->category ? $item->category->name : trans('general.na') }}</td>
                                                <td class="hidden-xs">{{ $item->account->name }}</td>
                                            </tr>
...
@push('scripts_start')
    <script src="{{ asset('public/js/modules/options.js?v=' . version('short')) }}"></script>
@endpush
