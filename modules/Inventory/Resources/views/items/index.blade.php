...
@section('new_button')
    @permission('create-common-items')
        ...
        <span><a href="{{ route('import.create', ['inventory', 'items']) }}" class="btn btn-white btn-sm header-button-top"><span class="fa fa-upload "></span> &nbsp;{{ trans('import.import') }}</a></span>
    @endpermission
            ...
            <table class="table table-flush table-hover">
                <thead class="thead-light">
                    <tr class="row table-head-line">
                        ...
                        <th class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">@sortablelink('name', trans('general.name'), ['filter' => 'active, visible'], ['class' => 'col-aka', 'rel' => 'nofollow'])</th>
                        <th class="col-lg-1 col-xl-1 hidden-lg">@sortablelink('category', trans_choice('general.categories', 1))</th>
                        <th class="col-md-2 col-lg-2 col-xl-2 text-right hidden-md">@sortablelink('sale_price', trans('items.sales_price'))</th>
                        <th class="col-lg-2 col-xl-2 text-right hidden-lg">@sortablelink('purchase_price', trans('items.purchase_price'))</th>
                        <th class="col-lg-1 col-xl-1 text-center hidden-lg">{{ trans('settings.invoice.quantity') }}</th>
                        <th class="col-xs-4 col-sm-3 col-md-2 col-lg-1 col-xl-1">@sortablelink('enabled', trans('general.enabled'))</th>
                        <th class="col-xs-4 col-sm-3 col-md-1 col-lg-1 col-xl-1 text-center"><a>{{ trans('general.actions') }}</a></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    @foreach($items as $item)
                        <tr class="row align-items-center border-top-1">
                            ...
                            <td class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 py-2">
                                ...
                                <a class="text-success" href="{{ route('items.show', $item->id) }}">{{ $item->name }}</a>
                            </td>
                            <td class="col-lg-1 col-xl-1 hidden-lg">
                                {{ $item->category ? $item->category->name : trans('general.na') }}
                            </td>
                            <td class="col-md-2 col-lg-2 col-xl-2 text-right hidden-md">
                            ...
                            <td class="col-lg-1 col-xl-1 text-center hidden-lg">
                                {{ isset($item->getInventoryItem($item->id)->opening_stock) ? $item->getInventoryItem($item->id)->opening_stock : 0 }}
                            </td>
                            ...
                            <td class="col-xs-4 col-sm-3 col-md-1 col-lg-1 col-xl-1 text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        @permission('delete-common-items')
                                            {!! Form::deleteLink($item, 'inventory/items') !!}
                                        @endpermission
                                    </div>
                                </div>
                            </td>
