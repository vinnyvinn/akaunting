...
<div class="row">
    <div class="col-md-3">
        ...
        <a href="{{ url('crm/companies/' . $company->id . '/edit') }}" class="btn btn-primary btn-block">
                    ...
                    <div class="card-header border-bottom-0 show-transaction-card-header">
                        ...
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                                {!! Form::deleteLink($companyContact, 'crm/modals/company/' . $contact->id . '/contact') !!}
                            </div>
                        </div>
                    </div>
                    @endforeach
                                ...
                                <div class="tab-pane fade" id="log">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <span class="col-md-6" v-if="log_selected_meeting">
                                            {{ Form::multiSelectGroup('user_id', trans_choice('crm::general.users', 2), 'user-circle', $users, request('user_id'), ['id' => 'users','class' => 'form-control col-md-12']) }}
                                        </span>

                                        <span class="col-md-6" v-if="log_selected_mail">
                                            {{ Form::textGroup('subject', trans('crm::general.subject'), 'id-card', ['required' => 'required', 'class' => 'form-control col-md-12']) }}
                                        </span> --}}
