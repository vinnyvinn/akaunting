    ...
    export default {
        ...
        methods: {
            change() {
                ...
                axios.post(`/inventory/warehouses/${this.real_model}/details`,{whs:this.options,item_id:this.item_id})
                .then(res => {
                    this.$store.dispatch('toWarehouse',res.data.warehouses);
                    this.$store.dispatch('itemDetails',res.data.item_details);
                    this.$store.state.from_warehouse = this.real_model
                    console.log('------------')
                    console.log(res.data.item_details)
                    console.log('pp---p--')
                })
            },
